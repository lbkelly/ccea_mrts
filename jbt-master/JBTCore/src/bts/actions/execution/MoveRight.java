...
public class MoveRight extends
	 ...
	 *            retrieved from.
	 */
	public MoveRight(bts.actions.MoveRight modelTask,
	...
	protected void internalSpawn() {
		...
		int maxX = ((GameState) getGameState()).getPhysicalGameState().getWidth();
		int x = 0;
		...
		if(f.getX()+1 >= maxX-1)
			...
			x = f.getX()+1;
		// This method moves the unit to the right
		Controller.move(f, x, f.getY());
