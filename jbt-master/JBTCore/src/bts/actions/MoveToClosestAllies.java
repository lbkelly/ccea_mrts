...
public class MoveToClosestAllies extends jbt.model.task.leaf.action.ModelAction {
	/**
	 ...
	 *            retrieved from.
	 */
	public MoveToClosestAllies(jbt.model.core.ModelTask guard,
	...
	public jbt.execution.core.ExecutionTask createExecutor(
		...
		return new bts.actions.execution.MoveToClosestAllies(this, executor,
