...
/** ModelAction class created from MMPM action Idle. */
public class Idle extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of Idle.
	 * 
	 * @param gameState
	 ...
	 *            retrieved from.
	 */
	public Idle(jbt.model.core.ModelTask guard, java.lang.Object gameState,
			java.lang.String gameStateLoc, java.lang.Integer player,
			java.lang.String playerLoc, java.lang.Object unit,
			java.lang.String unitLoc) {
		super(guard);
	...
	/**
	 * Returns a bts.actions.execution .Idle task that is able to run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new bts.actions.execution.Idle(this, executor, parent,
				this.gameState, this.gameStateLoc, this.player, this.playerLoc,
				this.unit, this.unitLoc);
	}
}