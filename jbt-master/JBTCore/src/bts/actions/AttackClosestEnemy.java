...
/** ModelAction class created from MMPM action AttackClosestEnemy. */
public class AttackClosestEnemy extends jbt.model.task.leaf.action.ModelAction {
	/**
	...
	/**
	 * Constructor. Constructs an instance of AttackClosestEnemy.
	 * 
	 * @param gameState
	 ...
	 *            retrieved from.
	 */
	public AttackClosestEnemy(jbt.model.core.ModelTask guard,
	...
	/**
	 * Returns a bts.actions.execution .AttackClosestEnemy task that is able to
	 * run this task.
	 */
	public jbt.execution.core.ExecutionTask createExecutor(
			jbt.execution.core.BTExecutor executor,
			jbt.execution.core.ExecutionTask parent) {
		return new bts.actions.execution.AttackClosestEnemy(this, executor,
