...
public class EnemyIsClose extends jbt.model.task.leaf.condition.ModelCondition {

	/** Constructor. Constructs an instance of EnemyIsClose. */
	public EnemyIsClose(jbt.model.core.ModelTask guard) {
		super(guard);
	}
	...
	public jbt.execution.core.ExecutionTask createExecutor(
		...
		return new bts.conditions.execution.EnemyIsClose(this, executor, parent);
	}
}