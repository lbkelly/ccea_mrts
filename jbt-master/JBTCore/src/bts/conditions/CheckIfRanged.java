...
public class CheckIfRanged extends jbt.model.task.leaf.condition.ModelCondition {

	/** Constructor. Constructs an instance of EnemyIsClose. */
	public CheckIfRanged(jbt.model.core.ModelTask guard) {
		super(guard);
	}
	...
	public jbt.execution.core.ExecutionTask createExecutor(
		...
		return new bts.conditions.execution.CheckIfRanged(this, executor, parent);
	}
}