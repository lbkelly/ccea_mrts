...
public class CheckIfHeavy extends jbt.model.task.leaf.condition.ModelCondition {

	/** Constructor. Constructs an instance of EnemyIsClose. */
	public CheckIfHeavy(jbt.model.core.ModelTask guard) {
		super(guard);
	}
	...
	public jbt.execution.core.ExecutionTask createExecutor(
		...
		return new bts.conditions.execution.CheckIfHeavy(this, executor, parent);
	}
}