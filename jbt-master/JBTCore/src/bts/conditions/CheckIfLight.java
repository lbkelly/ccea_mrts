...
public class CheckIfLight extends jbt.model.task.leaf.condition.ModelCondition {

	/** Constructor. Constructs an instance of EnemyIsClose. */
	public CheckIfLight(jbt.model.core.ModelTask guard) {
		super(guard);
	}
	...
	public jbt.execution.core.ExecutionTask createExecutor(
		...
		return new bts.conditions.execution.CheckIfLight(this, executor, parent);
	}
}