...
//                       DO NOT MODIFY                     
//                                                         
// Generated on 09/03/2018 14:26:41
// ******************************************************* 

/*
 * File is a modified version of the original MACHINE GENERATED CODE TTLibrary Java class file.
...
import bts.actions.MoveToClosestAllies;
 ...
 * </ul>
 */
public class TTLibrary implements jbt.execution.core.IBTLibrary {
	/** Tree generated from file TestTree.xbt. */
	private static jbt.model.core.ModelTask TestTree;
	...
	public jbt.model.core.ModelTask getBT(java.lang.String name) {
		if (name.equals("TestTree")) {
			return TestTree;
		}
		return null;
	}
	
	public jbt.model.core.ModelTask update(jbt.model.core.ModelTask tree) 
	{
		  TestTree = tree; 
