...
public class Custom_LightRush extends AbstractionLayerAI {
    Random r = new Random();
    ...
    public Custom_LightRush(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

        
    public Custom_LightRush(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new Custom_LightRush(utt, pf);
    }
