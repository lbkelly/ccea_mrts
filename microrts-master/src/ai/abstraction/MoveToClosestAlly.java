...
public class MoveToClosestAlly extends AbstractionLayerAI {
    Random r = new Random();
    ...
    public MoveToClosestAlly(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

        
    public MoveToClosestAlly(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new MoveToClosestAlly(utt, pf);
    }
