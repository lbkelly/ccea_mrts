...
//        if (doFinal) state.output.println("\nBest tree graph of Run:",statisticslog);
//        for(int y = 0; y< state.population.subpops.size(); y++ )
//        {    
//        if (doFinal) {
//        	GPIndividual ind = (GPIndividual) best_of_run[y];
//        	String tree = ind.trees[0].child.makeLatexTree();
//        	Parameter evolutionParam = new Parameter("evolutionfolder");
//        	String evolutionFolderName = state.parameters.getString(evolutionParam, null);
//        	state.output.println(tree, statisticslog);
