 ...
 * @author santi
 */
public class stateDialogWindow extends JDialog {
    ...
    public stateDialogWindow(Frame parent) throws Exception {  
    	super(parent,"State",true);
...
//                                                System.out.println(gs);
                                    ...
                                    if (trace!=null) {
                                        ...
                                        String traceFileName = stateDialogWindow.nextTraceName();
